...
class AgenstormSettings : PersistentStateComponent<AgenstormSettings.State> {
    ...
    data class State(
        ...
        /** Epic I: the ids of the rules switched off on the settings page, built-in or the user's own. */
        var terminalEnhancerDisabledRules: MutableList<String> = mutableListOf(),
        /**
        ...
        /** Epic O: New File, New Directory and Rename name the element in an editable row in the project tree. */
        var projectTreeInlineNamingEnabled: Boolean = true,
