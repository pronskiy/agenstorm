...
# message. Environment knobs: FAKE_CLAUDE_ARGS_FILE, FAKE_CLAUDE_STDIN_FILE, FAKE_CLAUDE_ENV_FILE (records
# MAX_THINKING_TOKENS), FAKE_CLAUDE_FAIL (exit 3 with stderr), FAKE_CLAUDE_SLEEP (seconds before answering).
