...
**Now on:** Epic E → Phase E1 → step **E1.4** (tab interactions: switch, close, "+" popup, context menu). Epic D is done except the **Daily-driver test** guardrail, which is Roman's over the coming commits (and owes a live run of the Anthropic and OpenAI-compatible backends with real keys).
