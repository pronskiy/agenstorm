...
| I2.4 | The five built-in rules as plugin resources | 🔄 | The five files landed with I1.2 (`resources/terminal/rules/`), loaded by `BlockDetector.builtInRules()`; left: the user override by id (with I3.1) |
